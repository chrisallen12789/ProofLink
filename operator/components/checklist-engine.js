(function (global) {
  ...
  function renderServerChecklist(payload) {
    ...
    return ''
      ...
      + '    <div>'
      + '      <h3>First wins</h3>'
      + '      <p>' + (launchReady ? 'The business is set up, working, and public-facing.' : 'Focus on the first real customer, work, and payment milestones before polishing everything else.') + '</p>'
      + '    </div>'
