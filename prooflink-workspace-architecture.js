(function () {
  ...
  const BUSINESS_PROFILES = {
    ...
    hydrovac: {
      ...
      pricingModel: "truck time + labor + disposal + mobilization + compliance-sensitive extras",
      inventoryModel: "truck stock + disposal tracking + regulated load handoff",
      proofModel: "locate tickets, manifests, permits, load records, and closeout proof",
      repeatWork: "Asset history, municipal cycles, and facility maintenance windows turn urgent work into repeat revenue.",
      bidProfile: "hydrovac_vactor",
      priorityViews: ["orders_jobs", "schedule", "proof", "expenses", "crm"],
      hiddenByDefault: [],
      defaultFeatures: ["photo_proof", "manual_payments", "custom_fields", "inventory_advanced", "reporting_advanced", "multi_operator"],
      advancedFeatures: ["approvals", "audit_log", "automations"],
      operatorNeeds: [
        "Dispatch crews with the compliance facts already attached to the job",
        "Track disposal, truck usage, and closeout proof without side systems",
        "Keep receivables, job costs, and regulated records tied to the same work record",
      ],
      recordFocus: [
        "Locate ticket, permit, and work-zone readiness",
        "Truck, disposal, and regulated load details",
        "Closeout proof, customer signoff, and follow-up billing context",
      ],
    },
